...
#asks for names and class, to be used later for outputs 
...
troubleQuestions.append(questionNumber)
#final score and outputting 
print("final score: ",score)
print("the questions that caused you trouble where: ",troubleQuestions)

import csv
with open('SaveFile.csv',mode = 'a') as SaveFile:
    SaveFileWriter = csv.writer(SaveFile, delimiter= ',', quotechar='"', quoting= csv.QUOTE_MINIMAL)

    SaveFileWriter.writerow([name, Stclass, score, troubleQuestions])

#write(name,"of class",Stclass,"scored",score,"points and struggled on questions",troubleQuestions)
